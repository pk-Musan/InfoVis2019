function Isosurfaces( volume, isovalue )
{
    ...
    function interpolated_vertex( v0, v1, val0, val1, s )
    {
        return new THREE.Vector3().addVectors( v0.multiplyScalar( Math.abs(val0-s) ), v1.multiplyScalar( Math.abs(s-val1)) ).divideScalar( Math.abs(val0-val1) );
    }
}